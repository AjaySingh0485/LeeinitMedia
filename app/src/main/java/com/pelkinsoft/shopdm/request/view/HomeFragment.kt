...
//            preference.getUserObjectFromPreference().shop_identifier,
//            fireStoreDatabase
//        )
...
//        viewModel.arrayRequest.observe(this, Observer { conversation ->
//
//            arrayRequest.addAll(conversation)
//            requestAdapter.notifyDataSetChanged()
//            checkForNodata()
//
//        })

        viewModel.addEventListenerForOpenChat(fireStoreDatabase,
            preference.getUserObjectFromPreference().shop_identifiers)
    ...
    private fun setupToolbar() {
        ...
        activity?.textTitle?.text = "Active Chats"
